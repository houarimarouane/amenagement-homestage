...
const STEP_ICONS = [
  ...
  /* 02 — Design & Moodboard : crayon-règle */
...
export default function AirbnbSection() {
  ...
  return (
    <>
      {/* ── 1. INTRO ── */}
      <section id="airbnb" className="py-28 px-6 bg-[#FAF8F5]">
