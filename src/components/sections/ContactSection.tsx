      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-[#FBF6F1] border border-[#E5E0DC] flex items-center justify-center shrink-0">
            ...
            {/* Right — form */}
            <div id="contact-form" className="lg:col-span-3 bg-[#FBF6F1] border border-[#E5E0DC] p-8 md:p-10">
              <ContactForm />
            </div>
          </div>
        </div>
